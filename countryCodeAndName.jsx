...
const countryDataList = countries.map((country) => {
...
// Filter out countries with null values
const validCountryDataList = countryDataList.filter((data) => data !== null);

export default validCountryDataList;
